            ...
            <div class="col-md-9">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <a href="{{ url('/admin/users_attribute/create') }}" class="btn btn-success btn-sm" title="Add New Role">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/admin/attributes', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
